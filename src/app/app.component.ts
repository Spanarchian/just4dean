...
export class MyApp {
    ...
    constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
        ...
        this.appMenuItems = [
            {title: 'Carehomes', component: PropertyListPage, icon: 'home'},
            {title: 'Providers', component: BrokerListPage, icon: 'people'},
            {title: 'Information', component: InfoListPage, icon: 'people'},
